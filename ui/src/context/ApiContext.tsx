...
export type ApiContextType = {
  ...
  larkAuthTest: (appId: string, appSecret: string) => Promise<any>;
  larkChats: (appId: string, appSecret: string) => Promise<any>;
  doctor: () => Promise<any>;
...
export const ApiProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const value: ApiContextType = {
    ...
    larkAuthTest: (appId, appSecret) => postJson('/lark/auth_test', { app_id: appId, app_secret: appSecret }),
    larkChats: (appId, appSecret) => postJson('/lark/chats', { app_id: appId, app_secret: appSecret }),
