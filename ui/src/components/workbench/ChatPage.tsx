...
export const ChatPage: React.FC = () => {
  ...
  return (
    ...
    <ImageViewerProvider images={sessionImages}>
      {/* Mobile: fill <main> exactly. <main> is 100dvh minus the header, and the
          ...
          notched iPhones. Desktop has no mobile header → full 100dvh. */}
      <div className="-mx-4 -my-5 flex h-[calc(100dvh_-_4rem_-_env(safe-area-inset-top))] flex-col md:-mx-10 md:-my-8 md:h-dvh">
